...
const PokemonPage: NextPage<{pokemon?: Pokemon}> = (props) => {
  ...
  return (
    ...
    <Image alt={`${pokemon.name} official artwork`} src={pokemon.sprites.other["official-artwork"].front_default!} width={360} height={360}></Image>
    <pre><code>{JSON.stringify(props.pokemon, null, 2)}</code></pre>
    </>
  )
}
